...
contract MyOFTAdapterTest is TestHelperOz5 {
    ...
    function test_send_oft_adapter() public {
        ...
        console2.log("adapter contract AFTER",aToken.balanceOf(address(aOFTAdapter)));
        console2.log("user A balance after AFTER",aToken.balanceOf(userA));

        console2.log("b token balance after",bOFT.balanceOf(userB));
        
        // console2.log("a token supply AFTER",aToken.totalSupply());
        // console2.log("dst oft token supply AFTER",bOFT.totalSupply());
        console2.log("************************************************************");

//         // check that oft is mintable
//         vm.prank(userB);
//         bOFT.mint(userB,1 ether);
//         console2.log("adapter contract MINT",aToken.balanceOf(address(aOFTAdapter)));
//          console2.log("user A balance after AFTER",aToken.balanceOf(userA));
//         console2.log("a token supply MINT",aToken.totalSupply());
//         console2.log("dst oft token supply MINT",bOFT.totalSupply());
// console2.log("************************************************************");

//         // check that oft is burnable
//         vm.prank(userB);
//         bOFT.burn(0.5 ether);
//         console2.log("adapter contract BURN",aToken.balanceOf(address(aOFTAdapter)));
//          console2.log("user A balance after AFTER",aToken.balanceOf(userA));
//         console2.log("a token supply BURN",aToken.totalSupply());
//         console2.log("dst oft token supply BURN",bOFT.totalSupply());
// console2.log("************************************************************");
       ...
       fee = bOFT.quoteSend(sendParam, false);
        ...
        // console2.log("receipt info",oftReceipt.amountReceivedLD);
        // console2.log("adapter contract TRANSFER BACK",aToken.balanceOf(address(aOFTAdapter)));
        //  console2.log("user A balance after AFTER",aToken.balanceOf(userA));
        // console2.log("a token supply TRANSFER BACK",aToken.totalSupply());
        // console2.log("dst oft token supply TRANSFER BACK",bOFT.totalSupply());
        // console2.log("************************************************************");

        console2.log("adapter contract AFTER BACK",aToken.balanceOf(address(aOFTAdapter)));
        console2.log("user A balance after AFTER BACK",aToken.balanceOf(userA));

        console2.log("b token balance after BACK",bOFT.balanceOf(userB));
        // TODO: status to drew/stiive
